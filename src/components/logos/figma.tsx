...
export default function FigmaLogo({ className, width = 24, height = 24 }: FigmaLogoProps) {
  return (
    <svg className={className} width={width} height={height} width="54" height="80" viewBox="0 0 54 80" fill="none" xmlns="http://www.w3.org/2000/svg">
