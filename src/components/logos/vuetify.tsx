...
interface VuetifyLogoProps {
  className?: string;
  width?: number | string;
  height?: number | string;
}

export default function VuetifyLogo({ className, width = 24, height = 24 }: VuetifyLogoProps) {
  return (
    <svg className={className} width={width} height={height} width="400" height="400" viewBox="0 0 400 400" fill="none" xmlns="http://www.w3.org/2000/svg">
<circle cx="200.025" cy="199.975" r="186.895" fill="white"/>
<path fillRule="evenodd" clip-rule="evenodd" d="M200.025 390.404C305.196 390.404 390.453 305.146 390.453 199.975C390.453 94.8048 305.196 9.54706 200.025 9.54706C94.8539 9.54706 9.59619 94.8048 9.59619 199.975C9.59619 305.146 94.8539 390.404 200.025 390.404ZM200.025 394.197C307.29 394.197 394.246 307.24 394.246 199.975C394.246 92.7098 307.29 5.75366 200.025 5.75366C92.7589 5.75366 5.8028 92.7098 5.8028 199.975C5.8028 307.24 92.7589 394.197 200.025 394.197Z" fill="#AEDDFF"/>
